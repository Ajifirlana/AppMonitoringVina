...
<table class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
          <tr>
            <form method="POST" action ="<?= base_url('dashboard/search')?>">
          ...
          <th><input type="date" class="form-control" name="tglmulai" placeholder="search" required="">
            ...
            <th><input type="submit" name="search_submit" class="btn btn-primary btn-flat" value="Tampilkan"></th>
            </form>
...
$link = set_linkurl($id,$ktgr);
          ...
          <tr>
            ...
            <td><?php 
              ...
              }else if ($row->Validasi == 'Tidak Valid'){
