      ...
      <!-- /.box-header -->
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Badan Pengawas Keuangan dan Pembangunan</h3>
            ...
            <div class="box-body">
               ...
               <center>
                <h1>
          "Auditor Internal Pemerintah RI Berkelas Dunia untuk Meningkatkan Pengelolaan dan Pembangunan Nasional diwilayah Perwakilan Provinsi Lampung"</h1>
        <img src="<?php echo base_url('assets/img/images.jpg');?>" width="500px" height="450px" alt=""></center>
            </div>
            <!-- /.box-body -->
